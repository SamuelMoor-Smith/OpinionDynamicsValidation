...
def no_noise_experiment(
    ...
    base_mean_diff, base_std_diff = calculate_mean_std(true, base_datasets[1:], "Baseline", method="wasserstein")

    # Plot the first and second datasets
    plot_2_datasets_snapshots(true, base_datasets[0], difference="wasserstein", path=f"plots/{model_name}/no_noise/same/")
