...
def real_data_experiment(
    ...
    plot_2_datasets_snapshots(true, opt_datasets[0], difference="wasserstein", path=f"plots/{model_type}/real_data/diff/", bins=11)
    ...
    write_results_to_file(
        ...
        path=f"results/{model_type}/real_data/"
    )
