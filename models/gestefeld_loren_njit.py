...
class GestefeldLorenz(Model):
    ...
    def run_with_njit(output, 
        ...
        for t in range(iterations):
            for i in range(n):
                ...
                if output[agent_i] > opinion_range[1]:
                    output[agent_i] = opinion_range[1]
                elif output[agent_i] < opinion_range[0]:
                    output[agent_i] = opinion_range[0]
    ...
    def run(self, input, p=None):
        ...
        return GestefeldLorenz.run_with_njit(
            output, 
            recipient_matrix, 
            sender_matrix, 
            idiosyncrasy_prob_draws, 
