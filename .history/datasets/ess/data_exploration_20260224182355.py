# File used to visualize the distribution of each variable across different ESS rounds. It reads the combined dataset, filters out invalid responses, and creates histograms for each variable by ESS round, saving the plots as PNG files in the specified folder.
...
file_path = 'datasets/ess/ess_datasets/combined-feb19.csv'  # Replace with the actual path to your data file
save_folder = 'datasets/ess/<CREATE_FOLDER_NAME>'  # Replace with the desired folder name to save the plots
